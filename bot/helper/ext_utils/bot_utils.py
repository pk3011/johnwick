...
def is_shourturl_link(url: str):
    return "urlsopen.com" in url or "urlsopen.net" in url

def is_appdrive_link(url: str):
    return "appdrive.in" in url or "appdrive.info" in url or "driveapp.in" in url or "gdflix.pro" in url or "drivehub.in" in url or "drivesharer.in" in url or "drivebit.in" in url or "drivelinks.in" in url or "driveace.in" in url or "drivepro.in" in url or "appdrive.pro" in url
...
def is_htp_link(url: str) :
    return "toonworld4all.me" in url or "shortingly.in" in url or "gplinks.in" in url or "shorturllink.in" in url
